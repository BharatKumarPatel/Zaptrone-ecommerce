          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="py-2 pl-10 block w-full border border-gray-300 rounded-md focus:ring-yellow-500 focus:border-yellow-500"
                />
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                I agree to the <Link to="/terms" className="text-yellow-600 hover:text-yellow-500">Terms of Service</Link> and <Link to="/privacy" className="text-yellow-600 hover:text-yellow-500">Privacy Policy</Link>
              </label>
            </div>
